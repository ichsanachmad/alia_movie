      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      child:
                          BlocConsumer<GetMovieHeaderBloc, GetMovieHeaderState>(
                              listener: (context, state) {
                        if (state is GetMovieHeaderErrorState) {
                          showSnackBar(context,
                              message:
                                  'Failed Getting Data, Swipe Up to Refresh');
                        }
            ...
            BlocConsumer<GetMovieHighlightListBloc, GetMovieHighlightListState>(
                listener: (context, state) {
              if (state is GetMovieHighlightListErrorState) {
                showSnackBar(context,
                    message: 'Failed Getting Data, Swipe Up to Refresh');
              }
            }, builder: (context, state) {
            ...
            BlocBuilder<GetMovieScheduleStreamBloc,
                GetMovieScheduleStreamState>(builder: (context, state) {
...
class _HomeHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: MediaQuery.of(context).size.width,
      child: BlocConsumer<GetMovieHeaderBloc, GetMovieHeaderState>(
        listener: (context, state) {
          if (state is GetMovieHeaderErrorState) {
            showSnackBar(context,
                message: 'Failed Getting Data, Swipe Up to Refresh');
